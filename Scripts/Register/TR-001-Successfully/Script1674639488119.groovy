...
WebUI.verifyElementPresent(findTestObject('Login-Register/Register Form/Firstname'), 3)

WebUI.setText(findTestObject('Login-Register/Register Form/Firstname'), 'Test')
