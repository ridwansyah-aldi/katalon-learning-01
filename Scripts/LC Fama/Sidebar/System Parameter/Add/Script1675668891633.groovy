...
WebUI.verifyElementPresent(findTestObject('LC Fama/Home Page/Sidebar/Add'), 10)

WebUI.click(findTestObject('LC Fama/Home Page/Sidebar/Add'))

WebUI.verifyElementPresent(findTestObject('LC Fama/Home Page/Add/Save'), 10)

WebUI.setText(findTestObject('LC Fama/Home Page/Add/Group Menu Name'), 'Test Add Group')

WebUI.click(findTestObject('LC Fama/Home Page/Add/Save'))

WebUI.verifyElementPresent(findTestObject('LC Fama/Home Page/Add/Insert'), 10)

WebUI.click(findTestObject('LC Fama/Home Page/Add/Insert'))
