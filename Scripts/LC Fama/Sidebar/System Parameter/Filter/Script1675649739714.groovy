...
WebUI.verifyElementPresent(findTestObject('LC Fama/Home Page/Sidebar/Table Group Management View'), 10)

WebUI.click(findTestObject('LC Fama/Home Page/Filter/Filter Button'))

WebUI.verifyElementPresent(findTestObject('LC Fama/Home Page/Filter/Add Rule'), 10)

WebUI.click(findTestObject('LC Fama/Home Page/Filter/Add Rule'))

WebUI.click(findTestObject('LC Fama/Home Page/Filter/Select Field'))

WebUI.click(findTestObject('LC Fama/Home Page/Filter/div_ID'))

WebUI.setText(findTestObject('LC Fama/Home Page/Filter/Enter Number'), '1')

WebUI.click(findTestObject('LC Fama/Home Page/Filter/OK'))

WebUI.click(findTestObject('LC Fama/Home Page/Filter/Close'))

WebUI.verifyElementNotPresent(findTestObject('LC Fama/Home Page/Filter/Table Data Not Found'), 10)
