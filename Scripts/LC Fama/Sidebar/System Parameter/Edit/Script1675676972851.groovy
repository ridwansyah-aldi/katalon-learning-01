...
WebUI.verifyElementPresent(findTestObject('LC Fama/Home Page/Edit/button_true_nawatable-row3-edit'), 10)

WebUI.click(findTestObject('LC Fama/Home Page/Edit/button_true_nawatable-row3-edit'))

WebUI.verifyElementPresent(findTestObject('LC Fama/Home Page/Edit/button_Save'), 10)

WebUI.setText(findTestObject('LC Fama/Home Page/Edit/Group Menu Name'), 'Ops Team Maker 2')

WebUI.click(findTestObject('LC Fama/Home Page/Edit/button_Save'))

WebUI.verifyElementPresent(findTestObject('LC Fama/Home Page/Edit/button_Update'), 10)

WebUI.click(findTestObject('LC Fama/Home Page/Edit/button_Update'))
