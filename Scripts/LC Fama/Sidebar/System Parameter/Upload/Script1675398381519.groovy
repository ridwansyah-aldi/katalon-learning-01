...
WebUI.verifyElementPresent(findTestObject('LC Fama/Home Page/Sidebar/Child SP - Group Menu Upload'), 10)

WebUI.click(findTestObject('LC Fama/Home Page/Sidebar/Child SP - Group Menu Upload'))

WebUI.verifyElementPresent(findTestObject('LC Fama/Home Page/Sidebar/Button Upload'), 10)

WebUI.click(findTestObject('LC Fama/Home Page/Sidebar/Button Upload'))

WebUI.uploadFile(findTestObject('LC Fama/Home Page/Sidebar/Box Upload'), 'C:\\Users\\NDS.NDS-LPT-0247\\Downloads\\Data Sample.xlsx')

WebUI.verifyElementPresent(findTestObject('LC Fama/Home Page/Sidebar/div_Upload Successfully'), 10)
